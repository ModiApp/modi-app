...
export function NotificationPrompt() {
  const { permissionStatus, requestPermission, isRequesting, error } = usePushNotification();
  ...
  // - User dismissed it
  // - Not on web (mobile handles this differently)
  if (dismissed || permissionStatus !== 'prompt') {
    return null;
  }
