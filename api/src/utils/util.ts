...
export async function getUsername(userId: string): Promise<string> {
  try {
    ...
    console.warn("Could not get username from Firebase Auth:", error);
...
// Note: deleteGame function removed as it depends on firebase-tools which isn't needed in core